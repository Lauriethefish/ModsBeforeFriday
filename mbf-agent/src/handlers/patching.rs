...
pub(super) fn handle_patch(downgrade_to: Option<String>,
    repatch: bool,
    manifest_mod: String,
    ...
    if !repatch {
        ...
        match super::install_core_mods(&res_cache, &mut mod_manager, super::mod_status::get_app_info()?
    ...
    Ok(Response::Patched { installed_mods: super::mod_management::get_mod_models(mod_manager)?, did_remove_dlc: removed_dlc })
}