...
function NoDiffAvailable({ version }: { version: string }) {
    return <div className="container mainContainer">
        ...
        <ol>
            <li>Go to your Quest headset’s library, find Beat Saber, press and hold on the app, and then select the settings option from the dropdown menu that appears.</li>
            <li>
                Once inside the settings menu, select <b>release channels</b>, and then change your version from <b>LIVE</b> to a different version that is <b>greater than or equal to the version you wish to downgrade to.</b>
                <p>For example, if you wanted to mod <b>1.40.8</b>, select <b>"legacy1.40.8_unity_v2021.3.1.16f1"</b> from the menu and hit confirm.</p>
            </li>
            <li>Reinstall your game.</li>
            <li>Refresh this page and reconnect to your Quest.</li>
        </ol>
        <a href="https://youtu.be/QQ02lgf9LO0" target='__blank'>Or watch the step-by-step video guide</a>
    </div>
}
